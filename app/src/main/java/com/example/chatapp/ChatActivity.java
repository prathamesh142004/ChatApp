...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otherUsername = findViewById(R.id.other_usename);
    ...
    void callApi(JSONObject jsonobject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAdMNVrrk:APA91bFOhxUEKoxP_kaffaSzuDyXRbgl9-t9r93kTZWQSR3egSoYa04IS4ys-u07cy9gJl0Ilepd1FCdPbFi-c8Rn8EfqnLyqbLLEM0tW5RVVL8ZMtKsBbQK86WL5jMvVcjc9o-Jjp-K")
                .build();
